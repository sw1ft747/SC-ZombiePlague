...
namespace INFECT_GRENADE
{

// Animations
enum Infect_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
string V_MODEL  	= "models/zombie_plague/v_grenade_infect_lefthanded.mdl";
...
class weapon_infectgrenade : ScriptBasePlayerWeaponEntity
{
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "INFECT_GRENADE::weapon_infectgrenade", GetName() ); // Register the weapon entity
