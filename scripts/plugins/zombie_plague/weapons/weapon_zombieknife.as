// Counter-Strike 1.6 Badlands Bowie Knife [Redacted as Zombie Claws for Zombie Plague Mod]
/* Model Sounds: Valve
...
namespace ZOMBIE_KNIFE
{

// Animations
enum Zombie_Knife_Animation
{
	KNIFE_IDLE1 = 0,
	KNIFE_DRAW,
	KNIFE_HOLSTER,
...
string V_MODEL  	= "models/zombie_plague/v_knife_zombie.mdl";
string P_MODEL  	= "models/zombie_plague/null.mdl";

// Sounds
string STAB_S   	= "zombie_plague/cs/knife/stab.wav"; //stab
// string DEPLOY_S 	= "cs16/knf/draw.wav"; //deploy1
string HITWALL_S 	= "zombie_plague/cs/knife/hitwall1.wav"; //hitwall1
array<string> 		KnifeHitFleshSounds =
{
					"zombie_plague/cs/knife/hit1.wav",
					"zombie_plague/cs/knife/hit2.wav",
					"zombie_plague/cs/knife/hit3.wav",
					"zombie_plague/cs/knife/hit4.wav"
};
array<string> 		KnifeSlashSounds =
{
					"zombie_plague/cs/knife/slash1.wav", //slash1
					"zombie_plague/cs/knife/slash2.wav"  //slash2
};
...
class weapon_zombieknife : ScriptBasePlayerWeaponEntity
{
	...
	bool Deploy()
	{
        ...
        self.DefaultDeploy( self.GetV_Model( V_MODEL ), self.GetP_Model( P_MODEL ), KNIFE_ATTACK1, "crowbar", 0, GetBodygroup() );
		self.m_flTimeWeaponIdle = self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = self.m_flNextTertiaryAttack = WeaponTimeBase() + (45.0/45.0);
		return true;
	}
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "ZOMBIE_KNIFE::weapon_zombieknife", GetName() ); // Register the weapon entity
