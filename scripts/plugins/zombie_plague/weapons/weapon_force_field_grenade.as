//Counter-Strike 1.6 High Explosive Grenade [Redacted as Force Field Grenade for Zombie Plague Mod]
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace FORCE_FIELD_GRENADE
{

// Animations
enum Force_Field_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
// Models
string W_MODEL  	= "models/zombie_plague/w_holy_grenade.mdl";
string V_MODEL  	= "models/zombie_plague/v_holy_grenade_lefthanded.mdl";
string P_MODEL  	= "models/zombie_plague/p_holy_grenade_v2.mdl";
...
class weapon_force_field_grenade : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/zombie_plague/weapons/weapon_force_field_grenade.txt" );
	}
...
string GetName()
{
	return "weapon_force_field_grenade";
}
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "FORCE_FIELD_GRENADE::weapon_force_field_grenade", GetName() ); // Register the weapon entity
