//Counter-Strike 1.6 High Explosive Grenade [Redacted as Jump Grenade for Zombie Plague Mod]
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace JUMP_GRENADE
{

// Animations
enum Jump_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
// Models
string W_MODEL  	= "models/zombie_plague/w_zombibomb.mdl";
string V_MODEL  	= "models/zombie_plague/v_zombibomb_lefthanded.mdl";
string P_MODEL  	= "models/zombie_plague/p_zombibomb.mdl";
...
class weapon_jumpgrenade : ScriptBasePlayerWeaponEntity
{
	...
	bool Deploy()
	{
		...
		self.m_flTimeWeaponIdle = self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = self.m_flNextTertiaryAttack = WeaponTimeBase() + (40.0/30.0);
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "JUMP_GRENADE::weapon_jumpgrenade", GetName() ); // Register the weapon entity
