...
namespace FROST_GRENADE
{

// Animations
enum Frost_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
// Models
string W_MODEL  	= "models/zombie_plague/cs/w_flashbang.mdl";
string V_MODEL  	= "models/zombie_plague/v_grenade_frost_lefthanded.mdl";
string P_MODEL  	= "models/zombie_plague/cs/p_flashbang.mdl";
...
class weapon_frostgrenade : ScriptBasePlayerWeaponEntity
{
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "FROST_GRENADE::weapon_frostgrenade", GetName() ); // Register the weapon entity
