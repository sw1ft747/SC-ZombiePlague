...
namespace FLARE_GRENADE
{

// Animations
enum Flare_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
// Models
string W_MODEL  	= "models/zombie_plague/cs/w_smokegrenade.mdl";
string V_MODEL  	= "models/zombie_plague/v_grenade_flare_lefthanded.mdl";
string P_MODEL  	= "models/zombie_plague/cs/p_smokegrenade.mdl";
...
class weapon_flaregrenade : ScriptBasePlayerWeaponEntity
{
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "FLARE_GRENADE::weapon_flaregrenade", GetName() ); // Register the weapon entity
