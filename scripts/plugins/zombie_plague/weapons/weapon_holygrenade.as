//Counter-Strike 1.6 High Explosive Grenade [Redacted as Holy Grenade for Zombie Plague Mod]
/* Model Credits
/ Model: Valve
/ Textures: Valve
/ Animations: Valve
...
namespace HOLY_GRENADE
{

// Animations
enum Holy_Grenade_Animations 
{
	IDLE = 0,
	PULLPIN,
	THROW,
...
class weapon_holygrenade : ScriptBasePlayerWeaponEntity
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/zombie_plague/weapons/weapon_holygrenade.txt" );
	}
...
void Register()
{
	...
	{
		g_CustomEntityFuncs.RegisterCustomEntity( "HOLY_GRENADE::weapon_holygrenade", GetName() ); // Register the weapon entity
